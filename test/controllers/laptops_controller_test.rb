...
class LaptopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laptop" do
    assert_difference('Laptop.count') do
      post laptops_url, params: { laptop: { gadget_id: @laptop.gadget_id, model: @laptop.model } }
    end
  ...
  test "should update laptop" do
    patch laptop_url(@laptop), params: { laptop: { gadget_id: @laptop.gadget_id, model: @laptop.model } }
